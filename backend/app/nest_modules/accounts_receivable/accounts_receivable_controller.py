...
class AccountsReceivableController:
    ...
    def get_accounts_receivable(
        ...
        return self.service.get_accounts(current_user.business_id, skip, limit, db)
    ...
    def update_account_receivable(
        ...
        return self.service.update_account(
            account_id, account_update, current_user.business_id, db
        )
    ...
    def delete_account_receivable(
        ...
        self.service.delete_account(account_id, current_user.business_id, db)
        return None
    ...
    def add_payment(
        self,
        account_id: int,
        payment: AccountReceivablePaymentCreate,
        db: Session = Depends(get_db),
        current_user: User = Depends(get_current_user),
    ) -> AccountReceivablePaymentResponse:
