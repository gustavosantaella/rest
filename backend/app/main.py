...
from .routers import auth, users, products, tables, orders, menu, configuration, profile, payment_methods, upload, public, permissions, roles, system_permissions, customers
